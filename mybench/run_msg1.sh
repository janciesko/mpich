...
hosts=$3
if [ x"$full" = x ]; then
  echo "Usage: sh run.sh DEVICE FULL(=0|1) hostlistPair"
...
date
${MPICH_PTH_PATH}/bin/mpiexec -n 2 --host ${hosts} hostname

for repeat in $(seq 1); do
    for comm_type in 0; do #1 2; do
        ...
        for winsize in ${winsize_list}; do
            ...
            for num_entities in ${num_entities_list}; do
                ...
                #MPI everywhere
                date
                echo "#### proc $num_messages_sp $num_entities $winsize $msgsize $comm_type"
                ...
                COMM_TYPE=${comm_type} NUM_REPEATS=${NUM_REPEATS} ${TIMEOUT} ${MPICH_PTH_PATH}/bin/mpiexec --host ${hosts} -n $(($num_entities * 2)) ${BIND} ./${DEVICE}_pth.out 0 $num_entities 1 $num_messages_sp $winsize $msgsize
                ...
                #MPI Pthread 1x VCI
                 ...
                 COMM_TYPE=${comm_type} NUM_REPEATS=${NUM_REPEATS} ${TIMEOUT} ${MPICH_PTH_PATH}/bin/mpiexec -n 2 --host ${hosts} ${BIND} ./${DEVICE}_pth.out 1 $num_entities 1 $num_messages_sp $winsize $msgsize
                ...
                if [ x"$full" != x0 ]; then
                     ...
                     COMM_TYPE=${comm_type} NUM_REPEATS=${NUM_REPEATS} ${TIMEOUT} ${MPICH_PTH_PATH}/bin/mpiexec -n 2 --host ${hosts}  ${BIND} ./${DEVICE}_pth.out 1 $num_entities $num_entities $num_messages_sp $winsize $msgsize
                     ...
                     COMM_TYPE=${comm_type} NUM_REPEATS=${NUM_REPEATS} MPIR_CVAR_CH4_NUM_VCIS=$(($num_entities + 2)) NOLOCK=0 ${TIMEOUT} ${MPICH_PTHVCI_PATH}/bin/mpiexec -n 2 --host ${hosts}  ${BIND} ./${DEVICE}_pthvci.out 1 $num_entities 1 $num_messages_sp $winsize $msgsize
                     ...
                     COMM_TYPE=${comm_type} NUM_REPEATS=${NUM_REPEATS} MPIR_CVAR_CH4_NUM_VCIS=$(($num_entities + 2)) NOLOCK=0 ${TIMEOUT} ${MPICH_PTHVCI_PATH}/bin/mpiexec -n 2  --host ${hosts}  ${BIND} ./${DEVICE}_pthvci.out 1 $num_entities $num_entities $num_messages $winsize $msgsize
                     ...
                     COMM_TYPE=${comm_type} NUM_REPEATS=${NUM_REPEATS} MPIR_CVAR_CH4_NUM_VCIS=$(($num_entities + 2)) NOLOCK=1 ${TIMEOUT} ${MPICH_PTHVCI_PATH}/bin/mpiexec -n 2 --host ${hosts}  ${BIND} ./${DEVICE}_pthvci.out 1 $num_entities $num_entities $num_messages $winsize $msgsize
                fi

                #date
                #echo "#### pth_vciopt_Ncomm $num_messages $num_entities $winsize $msgsize $comm_type"
                #echo "${ENVMSG}COMM_TYPE=${comm_type} NUM_REPEATS=${NUM_REPEATS} MPIR_CVAR_CH4_NUM_VCIS=$(($num_entities + 2)) NOLOCK=0 ${TIMEOUT} ${MPICH_PTHVCIOPT_PATH}/bin/mpiexec -n $(($num_entities * 2)) ${BIND} ./${DEVICE}_pthvciopt.out 1 $num_entities $num_entities $num_messages $winsize $msgsize"
                #COMM_TYPE=${comm_type} NUM_REPEATS=${NUM_REPEATS} MPIR_CVAR_CH4_NUM_VCIS=$(($num_entities + 2)) NOLOCK=0 ${TIMEOUT} ${MPICH_PTHVCIOPT_PATH}/bin/mpiexec -n $(($num_entities * 2)) --host ${hosts}  ${BIND} ./${DEVICE}_pthvciopt.out 1 $num_entities $num_entities $num_messages $winsize $msgsize
                ...
                # COMM_TYPE=${comm_type} NUM_REPEATS=${NUM_REPEATS} MPIR_CVAR_CH4_NUM_VCIS=$(($num_entities + 2)) NOLOCK=1 ${TIMEOUT} ${MPICH_PTHVCIOPT_PATH}/bin/mpiexec -n 2 --host ${hosts}  ${BIND} ./${DEVICE}_pthvciopt.out 1 $num_entities $num_entities $num_messages $winsize $msgsize
                ...
                #     COMM_TYPE=${comm_type} NUM_REPEATS=${NUM_REPEATS} ABT_MEM_LP_ALLOC=mmap_rp ABT_NUM_XSTREAMS=$num_entities MPIR_CVAR_CH4_NUM_VCIS=$(($num_entities + 2)) ${TIMEOUT} ${MPICH_ABT_PATH}/bin/mpiexec -n 2 --host ${hosts}  ${BIND} ./${DEVICE}_abt.out 1 $num_entities 1 $num_messages $winsize $msgsize
                # fi
                ...
                #     COMM_TYPE=${comm_type} NUM_REPEATS=${NUM_REPEATS} ABT_MEM_LP_ALLOC=mmap_rp ABT_NUM_XSTREAMS=1 MPIR_CVAR_CH4_NUM_VCIS=$(($num_entities + 2)) ${TIMEOUT} ${MPICH_ABT_PATH}/bin/mpiexec -n 2 --host ${hosts}  ${BIND} ./${DEVICE}_abt.out 1 $num_entities 1 $num_messages $winsize $msgsize
                ...
                #     COMM_TYPE=${comm_type} NUM_REPEATS=${NUM_REPEATS} ABT_MEM_LP_ALLOC=mmap_rp ABT_NUM_XSTREAMS=1 MPIR_CVAR_CH4_NUM_VCIS=$(($num_entities + 2)) ${TIMEOUT} ${MPICH_ABT_PATH}/bin/mpiexec -n 2 --host ${hosts}  ${BIND} ./${DEVICE}_abt.out 1 $num_entities $num_entities $num_messages $winsize $msgsize
                # fi
                ...
                # COMM_TYPE=${comm_type} NUM_REPEATS=${NUM_REPEATS} ABT_MEM_LP_ALLOC=mmap_rp ABT_NUM_XSTREAMS=$num_entities MPIR_CVAR_CH4_NUM_VCIS=$(($num_entities + 2)) ${TIMEOUT} ${MPICH_ABT_PATH}/bin/mpiexec -n 2  --host ${hosts}  ${BIND} ./${DEVICE}_abt.out 1 $num_entities $num_entities $num_messages $winsize $msgsize
                ...
                #         COMM_TYPE=${comm_type} NUM_REPEATS=${NUM_REPEATS} ABT_MEM_LP_ALLOC=mmap_rp ABT_NUM_XSTREAMS=$num_entities MPIR_CVAR_CH4_NUM_VCIS=$(($num_entities + 2)) ${TIMEOUT} ${MPICH_ABT_PATH}_${OPT_NUM}/bin/mpiexec -n 2 --host ${hosts}  ${BIND} ./${DEVICE}_abt_${OPT_NUM}.out 1 $num_entities $num_entities $num_messages $winsize $msgsize
                #     done
                # fi
            done
        done
